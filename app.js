...
<div style="line-height:25px;font-size:1px">&#160;</div>  <img class="center  autowidth  fullwidth" align="center" border="0" src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/20/rounder-up.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 600px" width="600">
  ...
  <img class="center fixedwidth" align="center" border="0" src="images/fuchsia-logo.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 240px" width="240">
  ...
  <div style="color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;"> 
    <div style="font-size:12px;line-height:18px;color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><strong>Tu periodo de prueba de 30 días comienza hoy.</strong><br>&#160;<br>Puedes ingresar a tu plataforma de negocio a través de:&#160;<br><span style="color: rgb(200, 56, 94); font-size: 14px; line-height: 21px;"><a style="text-decoration: none; color: #c8385e;" href="https://luisin.yourbeauty.com.pa" target="_blank" rel="noopener"><span style="font-size: 14px; line-height: 21px;"><strong>luisin.yourbeauty.com.pa</strong></span></a></span><br><br>Tu usuario es: <strong><span style="color: rgb(200, 56, 94); font-size: 14px; line-height: 21px;">Angels</span></strong><span style="color: rgb(168, 191, 111); font-size: 14px; line-height: 21px;"><strong><br></strong></span></p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Tu contraseña:&#160;<strong><span style="color: rgb(200, 56, 94); font-size: 14px; line-height: 21px;">Angels</span></strong></p></div>  
  </div>
...
<div align="center" class="button-container center " style="padding-right: 10px; padding-left: 10px; padding-top:25px; padding-bottom:10px;">
    ...
    <a href="http://www.google.com" target="_blank" style="display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #c8385e; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; max-width: 154px; width: 124px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 15px; padding-right: 15px; padding-bottom: 15px; padding-left: 15px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;mso-border-alt: none">
...
<div align="center" class="button-container center " style="padding-right: 10px; padding-left: 10px; padding-top:25px; padding-bottom:10px;">
    <a href="http://www.apple.com" target="_blank" style="display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #c8385e; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; max-width: 148px; width: 118px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 15px; padding-right: 15px; padding-bottom: 15px; padding-left: 15px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;mso-border-alt: none">
...
WHERE  c.fechaExpira > CURRENT_TIMESTAMP AND c.estado = 1  ORDER BY c.porcentajeDescuento DESC LIMIT 1`,[req.body.idCentro,req.body.idCliente]),
  ...
  expressApp.post('/addCitaManual2', (req, res) => {
    ...
    db(`SELECT s.idServicio, s.nombre, s.duracion, s.precio, sc.precioCobrado, sc.idCita, sc.idServicioCita, sc.horaInicio, sc.horaFin, s.idCategoria, e.idFoto as idFotoE, e.nombre as nombreEmpleado, c.nombre as nombreCategoria  
...
ORDER BY c.porcentajeDescuento DESC LIMIT 1`,[req.body.idCentro,req.body.idCliente])])
  ...
  expressApp.post('/getSAInfo', (req, res) => {
    ...
    db(`SELECT e.nombre, e.descripcion, e.telefono, e.email, e.idFoto, e.estado, e.tipo, e.idEmpleado FROM empleado as e WHERE
