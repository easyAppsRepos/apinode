...
/*    var db = req.db;
    ...
    db(`SELECT r.*, u.username FROM requests as r INNER JOIN usuarios as u ON u.idStore = r.instagramId  WHERE r.idInfluencer = ? OR r.idStore = ?`,[req.body.id, req.body.id]).then((data) => {
