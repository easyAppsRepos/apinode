...
/*    var db = req.db;
    ...
    db(`SELECT r.*, u.username FROM requests as r INNER JOIN usuarios as u ON u.instagramId = r.idStore  WHERE r.idInfluencer = ? OR r.idStore = ?`,[req.body.id, req.body.id]).then((data) => {
