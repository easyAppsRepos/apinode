...
// console.log(req.body);
   ...
   // let horaFinal = moment(req.body.fecha).format("YYYY-MM-DD");
    ...
    db(`SELECT s.idServicio, s.nombre, s.duracion, s.precio, sc.precioCobrado, sc.horaInicio, sc.horaFin, s.idCategoria, e.idFoto as idFotoE, e.nombre as nombreEmpleado, c.nombre as nombreCategoria  
